...
namespace Adventure
{
    class Adventure
    {
        ...
        {
            Console.WriteLine("Enter a number between 1 and 3 to find out how your story ends.");
            userInput = Console.ReadLine();
            switch (userInput)
            {
                case "1":
                    Console.WriteLine("A jeep full of tourists found you and brought you home.");
                    break;
                case "2":
                    Console.WriteLine("You woke up from your dream and decided to never travel again.");
                    break;
                case "3":
                    Console.WriteLine("You came to the realization that you would be stranded forever.");
